        ...
        return (
            <section>
                ...
                <div className="services-box" >
                    ...
                    <div className="slide-services desk">
                            ...
                            <div className="uk-position-relative uk-visible-toggle uk-light" tabIndex="-1">
                                ...
                                <ul className="uk-slider-items uk-child-width-1-2@s uk-grid">
                                    <li>
                                        <div className="card-service">
                                            <div className="uk-card-media-top" style={{float:"right"}}>
                                                <img src="https://firebasestorage.googleapis.com/v0/b/camp-92fe8.appspot.com/o/-Kzorqdwn3S9Ecl7LZB6%2Fdev.png?alt=media&token=304af209-ae23-4c3b-93ec-77ac1c534542" alt="desarrollo"/>
                                            </div>
                                            <br/>
                                    ...
                                    <li>
                                        <div className="card-service">
                                            <div className="uk-card-media-top" style={{float:"right"}}>
                                                <img src="https://firebasestorage.googleapis.com/v0/b/camp-92fe8.appspot.com/o/-Kzorqdwn3S9Ecl7LZB6%2Fapps.png?alt=media&token=5bf76c59-2690-496a-8236-f82285e00a34" alt="apps moviles"/>
                                            </div>
                                            <br/>
                                            <div className="uk-card-body">
                                    ...
                                    <li>
                                        <div className="card-service">
                                            <div className="uk-card-media-top" style={{float:"right"}}>
                                                <img src="https://firebasestorage.googleapis.com/v0/b/camp-92fe8.appspot.com/o/-Kzorqdwn3S9Ecl7LZB6%2Fdesign.png?alt=media&token=e0b53d5d-bd1e-4ff1-b541-b7a92fc9a5d5" alt="web design"/>
                                            </div>
                                            <br/>
                                            <div className="uk-card-body">
                                                <h3>Diseño web</h3>
                                    ...
                                    <li>
                                        <div className="card-service">
                                            <div className="uk-card-media-top" style={{float:"right"}}>
                                                <img src="https://firebasestorage.googleapis.com/v0/b/camp-92fe8.appspot.com/o/-Kzorqdwn3S9Ecl7LZB6%2Fpubli.png?alt=media&token=2fd5b18f-c4d9-4355-95ea-2981733d2f97" alt="publicidad"/>
                                            </div>
                                            <br/>
                                            <div className="uk-card-body">
                                    ...
                                    <li>
                                        <div className="card-service">
                                            <div className="uk-card-media-top" style={{float:"right"}}>
                                                <img src="https://firebasestorage.googleapis.com/v0/b/camp-92fe8.appspot.com/o/-Kzorqdwn3S9Ecl7LZB6%2Fcap.png?alt=media&token=78ddc19e-d267-459c-973e-269bc30f2ff0" alt="consultoria"/>
                                            </div>
                                            <br/>
                                            <div className="uk-card-body">
...
"
                                ...
                                <a className="uk-position-center-right uk-position-small uk-hidden-hover" href="#"
                                   uk-slidenav-next uk-slider-item="next"><p style={{display:"none"}}>Next</p></a>
